    ...
    def export_destination_insights(
        ...
        try:
            ...
            if export_mode == "comprehensive":
                export_data = self._create_comprehensive_export(destination, destination_id, analysis_metadata, evidence_registry)
            elif export_mode == "minimal":
                export_data = self._create_minimal_export(destination, destination_id, evidence_registry)
            elif export_mode == "summary_only":
                export_data = self._create_summary_export(destination, destination_id, evidence_registry)
            elif export_mode == "evidence_focused":
                export_data = self._create_evidence_focused_export(destination, destination_id, evidence_registry)
            elif export_mode == "themes_focused":
                export_data = self._create_themes_focused_export(destination, destination_id, evidence_registry)
            else:
